...
- Кастомная админка проекта: `http://127.0.0.1:8000/admin.html`
- Стандартная Django Admin: `http://127.0.0.1:8000/django-admin/`
...
- Кастомная админка в production доступна только авторизованным staff-пользователям.
...
1. Открыть `admin.html` -> `Продажи` -> `Заказы`.
